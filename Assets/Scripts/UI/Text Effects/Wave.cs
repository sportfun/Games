...
public class Wave : MonoBehaviour
{
    ...
    private IEnumerator AnimateWave()
    {
        ...
        while (elapsedTime < this._animationDuration * this._animationSpeed)
        {
            ...
            yield return null;
            elapsedTime += Time.deltaTime * this._animationSpeed;
        }
    ...
    {
        return (new Vector3(0, this._vertexCurve.Evaluate(elapsedTime - i * (this._vertexCurve.keys[this._vertexCurve.keys.Length - 1].time / count)) * this._animationScale, 0));
    }
}
